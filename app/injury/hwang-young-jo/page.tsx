          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                // ⚠️ 2026-09-14: "완만한 오르막은 평지보다 무릎 충격이 적습니다" 에 인용이 없다.
                // 이 페이지의 유일한 출처는 네이버 인물정보(황영조 기록)이고 생체역학 자료가 없다.
                // 단정을 빼고 "그렇게 이야기된다" 수준으로 낮춘다.
                desc: "황영조 선수가 몬주익 언덕에서 역전할 수 있었던 이유 중 하나는 오르막 훈련입니다. 완만한 오르막은 보폭이 자연히 줄어 평지보다 무릎 부담이 적다고 이야기되지만, 저희가 확인한 연구 자료는 없습니다. 내리막은 반대로 부담이 커지니 그쪽을 더 조심하세요.",
              },
            ].map((item, i) => (
