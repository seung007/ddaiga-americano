  ...
  return (
    <>
      ...
      <article className="max-w-2xl mx-auto px-6 py-12 text-gray-800">
         ...
         *
         * ⚠️ **제목은 안 바꿨다.** 바꾸고 싶었지만 제목에 「미드풋」이 들어 있어서,
         * 바꾸면 「미드풋」 검색어(노출 1위, 9/25 판정 대상)의 결과가 달라진다.
         * 판정 전에 처방을 더하는 것 — 이 저장소가 §4-4 에서 네 번 기록한 실수다.
         * **제목 변경은 9/25 이후.**
         *
         * 그래서 본문만 넓힌다. 스트레칭 3종은 원인과 무관하게 유효하다는 것을
