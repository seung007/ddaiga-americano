    ...
    <>
      <article className="max-w-2xl mx-auto px-6 py-12 text-gray-800">
        ...
        <section className="mb-8">
          ...
          {/**
           * ⚠️ 2026-09-14 — 저장소 자신과 모순이었다.
           *
           * 원문: *"「10% 법칙」이라고 불리는 이 원칙은 엘리트 선수뿐 아니라 모든 러너에게
           *        적용되는 가장 기본적인 과부하 예방법입니다."*
           *
           * `/injury/beginner-guide:64` 가 이미 정정해 뒀다 — *"10%라는 숫자 자체를
           * 뒷받침하는 연구는 없습니다."* Nielsen 2014 JOSPT 초록: 세 증가율 군 사이에
           * 부상률의 통계적 유의차가 없었다.
           *
           * 정정된 것을 다른 페이지가 「법칙」으로 되돌려 놓은 상태였다.
           * 방향(조금씩 늘린다)은 남기고 **「법칙」이라는 지위만 뺐다.**
           */}
          <p className="leading-relaxed text-gray-700">
            초보 러너에게 이 원칙을 적용하면 간단합니다. 주당 거리를 한 번에 크게 늘리지 않는 것.
            흔히 &ldquo;10% 법칙&rdquo;이라고 부르지만,{" "}
            <strong>10%라는 숫자 자체를 뒷받침하는 연구는 없습니다.</strong>{" "}
            증가율을 나눠 비교한 연구에서 부상률의 유의한 차이가 나오지 않았습니다 —
            정확한 숫자보다 <strong>&ldquo;급격히 늘리지 않는다&rdquo;</strong>는 방향이 요점입니다.
          </p>
        </section>
      ...
      { label: "인생은 마라톤처럼 — 21년간 한국신기록을 보유한 권은주 감독", channel: "다컴스", url: "https://www.youtube.com/watch?v=0tPsua6vVHQ" },
        ...
        <FaqSection items={[
          ...
          },
          {
            ...
            a: "주당 거리를 급격히 늘리지 않는 것입니다. 흔히 '10% 법칙'이라고 부르지만 10%라는 숫자를 뒷받침하는 연구는 없습니다 — 증가율을 나눠 비교한 연구에서 부상률의 유의한 차이가 나오지 않았습니다. 정확한 숫자보다 '조금씩 늘린다'는 방향이 요점입니다.",
          },
        ]} />
