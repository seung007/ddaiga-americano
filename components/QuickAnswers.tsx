...
const ITEMS = [
  {
    ...
    // ⚠️ 2026-09-12 정정. 부제가 "드롭이 두 배 차이"였는데 **틀린 숫자**다.
    // 카본화를 뺀 데일리 평균이 호카 6.2mm / 브룩스 11.0mm — 1.77배다.
    // 게다가 목적지 페이지에는 "두 배"라는 말이 아예 없다. 카드가 약속한 것을
    // 도착지가 말하지 않으면 **광고가 되고 신뢰가 깎인다.**
    // 목적지의 실제 결론("범위가 겹치지 않는다")을 그대로 쓴다.
    q: "호카 vs 브룩스",
    a: "드롭 범위가 안 겹쳐요",
  },
  {
